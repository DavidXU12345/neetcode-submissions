class Solution:
    def exist(self, board: List[List[str]], word: str) -> bool:
        ...
        def dfs(row, col, matched_word, visited):
            ...
            return dfs(row + 1, col, matched_word, visited) or dfs(row - 1, col, matched_word, visited) or dfs(row, col + 1, matched_word, visited) or dfs(row, col - 1, matched_word, visited)
